...
class Acf_Media_Box extends \acf_field {
	...
	public function __construct() {
		 ...
		 */
		$this->label = __( 'Media Box', 'DigitalAgency_td' );
	...
	public function input_admin_enqueue_scripts() {
		\DigitalAgency::enqueue_scripts( array( 'assets/build/vendors/media-box.js' ) );
	}
	...
	public function render_field( $field ) {
		...
		<div class="acf-fields -top -border">
			<div class="acf-field acf-field-button-group -r0" style="width: 50%; min-height: 92px;" data-name="media_option" data-type="button_group" data-key="" data-width="50">
				<div class="acf-label">
				<label for=""><?php esc_html_e( 'Media Option', 'DigitalAgency_td' ); ?></label>
				</div>
				<div class="acf-input">
			...
			<div class="acf-field acf-field-inner acf-field-image -r0" style="width: 50%; min-height: 92px;<?php echo ( 'image' === $field_media_option ) ? '' : 'display:none;'; ?>" data-name="image" data-width="50">
				<div class="acf-label">
					<label for=""><?php esc_html_e( 'Image', 'DigitalAgency_td' ); ?></label>
				</div>
				<div class="acf-input">
					<div class="acf-image-uploader <?php echo ( '' !== $field_media_image ) ? 'has-value' : ''; ?>">
						...
						<div class="hide-if-value">
							<p><?php esc_html_e( 'No image selected ', 'DigitalAgency_td' ); ?> <a data-name="add" class="acf-button button" href="#"><?php esc_html_e( 'Add Image', 'DigitalAgency_td' ); ?></a></p>
						</div>
					</div>
				</div>
			</div>
			...
			<div class="acf-field acf-field-inner acf-field-file -r0" style="width:50%;<?php echo ( 'video' === $field_media_option ) ? '' : 'display:none;'; ?>" data-name="video" data-width="50">
				<div class="acf-label">
				<label for=""><?php esc_html_e( 'Video', 'DigitalAgency_td' ); ?></label>
				</div>
				<div class="acf-input">
				<div class="acf-file-uploader <?php echo ( '' !== $field_media_video ) ? 'has-value' : ''; ?>">
					...
					<div class="show-if-value file-wrap <?php echo ( '' !== $field_media_video ) ? '' : 'show-if-value'; ?>">
						...
						<div class="file-info">
							...
							<p>
							<strong><?php esc_html_e( 'File name:', 'DigitalAgency_td' ); ?></strong>
							...
							<p>
							<strong><?php esc_html_e( 'File size:', 'DigitalAgency_td' ); ?></strong>
					...
					<div class="hide-if-value">
						<p><?php esc_html_e( 'No video selected', 'DigitalAgency_td' ); ?> <a data-name="add" class="acf-button button" href="#"><?php esc_html_e( 'Add Video', 'DigitalAgency_td' ); ?></a></p>
					</div>
				</div>
				</div>
			</div>
