...
class WP_Theme_Blog_Url {
	...
	public function __construct() {
		...
		if ( '' !== $post_custom_permalink ) {
			...
			add_action( 'generate_rewrite_rules', array( $this, 'DigitalAgency_posts_add_rewrite_rules' ) );
	 ...
	 */
	public function DigitalAgency_posts_add_rewrite_rules( $wp_rewrite ) {
		$post_custom_permalink = get_option( 'post_custom_permalink' );
		$new_rules             = array(
