...
namespace DigitalAgency\Walker\Settings;
...
class WP_Theme_Walker_Settings {
	...
	public function acf_init_location_types() {
		...
		if ( function_exists( 'acf_register_location_type' ) ) {
			acf_register_location_type( '\DigitalAgency\Walker\Settings\ACF\WP_Theme_Walker_Acf_Settings' );
			if ( is_multisite() ) {
				acf_register_location_type( '\DigitalAgency\Walker\Settings\ACF\WP_Theme_Acf_Multisite_Support' );
			}
		}
	}
}
