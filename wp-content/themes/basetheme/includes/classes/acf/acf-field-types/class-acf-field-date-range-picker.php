...
class Acf_Field_Date_Range_Picker extends \acf_field {
	...
	public function __construct() {
		 ...
		 */
		$this->label = __( 'Date Range Picker', 'DigitalAgency_td' );
	...
	public function input_admin_enqueue_scripts() {
		\DigitalAgency::enqueue_scripts( array( 'assets/build/vendors/moment.min.js', 'assets/build/vendors/daterangepicker.min.js' ) );
	}
