...
class WP_Theme_Setup {
	...
	public function setup_function() {
		...
		load_theme_textdomain( 'Digital_td' );
		...
		register_nav_menus(
			array(
				'header-nav'       => __( 'Header Nav', 'Digital_td' ),
				'footer-nav-one'   => __( 'Footer Nav One', 'Digital_td' ),
				'footer-nav-two'   => __( 'Footer Nav Two', 'Digital_td' ),
				'footer-nav-three' => __( 'Footer Nav Three', 'Digital_td' ),
				'legal-nav'        => __( 'Legal Nav', 'Digital_td' ),
			)
		);
