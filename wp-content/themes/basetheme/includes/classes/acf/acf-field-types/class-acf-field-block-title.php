...
namespace DigitalAgency\Acf\Acf_Fields;
...
class Acf_Field_Block_Title extends \acf_field {
	...
	public function __construct() {
		 ...
		 */
		$this->label = __( 'Block Title', 'DigitalAgency_td' );
		...
		$this->l10n     = array( 'error' => __( 'Error! Please enter a higher value', 'DigitalAgency_td' ) );
	...
	public function render_field_settings( $field ) {
		...
		acf_render_field_setting(
			$field,
			array(
				'label'        => __( 'Instructions (Block Title)', 'DigitalAgency_td' ),
				'instructions' => __( 'Customize the Block Title input instructions', 'DigitalAgency_td' ),
				'type'         => 'text',
		...
		acf_render_field_setting(
			$field,
			array(
				'label'        => __( 'Instructions ( HTML Tag)', 'DigitalAgency_td' ),
				'instructions' => __( 'Customize the HTML tag input instructions', 'DigitalAgency_td' ),
				'type'         => 'text',
		...
		<div class="acf-input">
			<div class="acf-clone-fields acf-fields">
				<div class="acf-field acf-field-text -r0" style="width: 70%; min-height: 113px;" data-name="title" data-width="70">
					<div class="acf-label">
						<label for=""><?php esc_html_e( 'Block Title', 'DigitalAgency_td' ); ?></label>
				...
				<div class="acf-field acf-field-headings is-padding -r0" style="width: 30%; min-height: 113px;" data-name="title_tag"  data-width="30">
					<div class="acf-label">
						<label for=""><?php esc_html_e( 'HTML Tag', 'DigitalAgency_td' ); ?></label>
					...
					<div class="acf-input">
						...
						<?php if ( 'yes' === $is_h1 ) { ?>
							<option <?php echo html_entity_decode( ( 'h1' === $field_title_tag ? 'selected="selected"' : '' ) ); ?> value="h1"><?php esc_html_e( 'h1', 'DigitalAgency_td' ); ?></option>
						<?php } ?>
						<option <?php echo html_entity_decode( ( 'h2' === $field_title_tag ) ? 'selected="selected"' : '' ); ?> value="h2"><?php esc_html_e( 'h2', 'DigitalAgency_td' ); ?></option>
						<option <?php echo html_entity_decode( ( 'h3' === $field_title_tag ) ? 'selected="selected"' : '' ); ?> value="h3"><?php esc_html_e( 'h3', 'DigitalAgency_td' ); ?></option>
						<option <?php echo html_entity_decode( ( 'h4' === $field_title_tag ) ? 'selected="selected"' : '' ); ?> value="h4"><?php esc_html_e( 'h4', 'DigitalAgency_td' ); ?></option>
						<option <?php echo html_entity_decode( ( 'h5' === $field_title_tag ) ? 'selected="selected"' : '' ); ?> value="h5"><?php esc_html_e( 'h5', 'DigitalAgency_td' ); ?></option>
						<option <?php echo html_entity_decode( ( 'h6' === $field_title_tag ) ? 'selected="selected"' : '' ); ?> value="h6"><?php esc_html_e( 'h6', 'DigitalAgency_td' ); ?></option>
						</select>
					</div>
				</div>
			</div>
