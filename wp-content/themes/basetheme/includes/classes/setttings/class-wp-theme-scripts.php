...
namespace DigitalAgency\Script;
...
define( 'DigitalAgency_PROJECT_DTFORMAT', 'F j, Y' );
/**
 * Theme assets
 *
...
class WP_Theme_Scripts {
	...
	public function theme_assets() {
		...
		DigitalAgency::enqueue_style( 'assets/build/styles.min.css' );
		if ( wp_is_mobile() ) {
			DigitalAgency::enqueue_style( 'assets/build/mobile.min.css' );
		}
	...
	public function admin_assets() {
		...
		DigitalAgency::enqueue_style( 'assets/build/editor.min.css' );
	}
}
