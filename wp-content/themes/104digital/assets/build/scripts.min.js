...
var map = {
	"./lead-paragraph-reveal.js": "./assets/src/js/partials/lead-paragraph-reveal.js",
...
/***/ "./assets/src/js/partials/lead-paragraph-reveal.js":
/*!*********************************************************!*\
  !*** ./assets/src/js/partials/lead-paragraph-reveal.js ***!
  \*********************************************************/
/***/ (() => {
...
jQuery(function () {
  ...
  jQuery('.header-nav').on('click', '.submenu-icon', function () {
    ...
    parentLi.siblings('.active').removeClass('active').find('ul, .mega-menu').slideUp();
