...
class Acf_Field_Advance_Form extends \acf_field {
	...
	public function __construct() {
		 ...
		 */
		$this->label = __( 'Advance Form', 'Digital_td' );
		...
		<div class="acf-input">
			<div class="acf-clone-fields acf-fields">
				<div class="acf-field acf-field-button-group -r0" style="width: 40%;" data-name="option" data-width="40">
					<div class="acf-label">
						<label for=""><?php esc_html_e( 'Form Provider', 'Digital_td' ); ?></label>
						<p class="description"><?php esc_html_e( 'Select From Provider', 'Digital_td' ); ?></p>
					</div>
					<div class="acf-input">

						<div class="acf-button-group">
						<label <?php echo ( 'gform' === $field_form_provider ) ? 'class="selected"' : ''; ?>><input type="radio" name="<?php echo esc_html( $field_save_name . '[form_provider]' ); ?>" value="gform" checked="checked"> <?php esc_html_e( 'Gravity Form', 'Digital_td' ); ?></label>
						<label <?php echo ( 'hubspot' === $field_form_provider ) ? 'class="selected"' : ''; ?>><input type="radio" name="<?php echo esc_html( $field_save_name . '[form_provider]' ); ?>" value="hubspot"> <?php esc_html_e( 'Hubspot Form', 'Digital_td' ); ?></label></div>
					</div>
				</div>
				<div class="acf-field acf-field-inner acf-field-forms -r0" style="width: 60%;<?php echo ( 'gform' === $field_form_provider ) ? '' : 'display:none;'; ?>" data-name="gform" data-width="60">
					<div class="acf-label">
						<label for=""><?php esc_html_e( 'Gravity Form', 'Digital_td' ); ?></label>
						<p class="description"><?php esc_html_e( 'Select gravity form', 'Digital_td' ); ?></p>
					</div>
					<div class="acf-input">
						<select id="" name="<?php echo esc_html( $field_save_name . '[gform]' ); ?>">
						<option value=""><?php esc_html_e( '- Select a form -', 'Digital_td' ); ?></option>
						<?php
				...
				<div class="acf-field acf-field-inner acf-field-textarea -r0" style="width: 60%;<?php echo ( 'hubspot' === $field_form_provider ) ? '' : 'display:none;'; ?>" data-name="hubspot" data-width="60">
					<div class="acf-label">
						<label for=""><?php esc_html_e( 'Hubspot Form', 'Digital_td' ); ?></label>
						<p class="description"><?php esc_html_e( 'Add your hubspot code here', 'Digital_td' ); ?></p>
					</div>
					<div class="acf-input">
