...
class Acf_Field_Spacers extends \acf_field {
	...
	public function render_field_settings( $field ) {
		...
		acf_render_field_setting(
			$field,
			array(
				'label'        => __( 'Instructions (Margin From Top)', 'DigitalAgency_td' ),
				'instructions' => __( 'Customize the Margin From Top input instructions', 'DigitalAgency_td' ),
				'type'         => 'text',
		...
		acf_render_field_setting(
			$field,
			array(
				'label'        => __( 'Instructions ( Margin From Bottom)', 'DigitalAgency_td' ),
				'instructions' => __( 'Customize the Margin From Bottom input instructions', 'DigitalAgency_td' ),
				'type'         => 'text',
