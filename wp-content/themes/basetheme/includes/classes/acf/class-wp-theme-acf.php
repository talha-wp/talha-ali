...
class WP_Theme_Acf {
	...
	public function __construct() {
		...
		if ( function_exists( 'acf_add_options_page' ) ) {
			$option_page = acf_add_options_page(
				array(
					'page_title' => __( 'Theme Options', 'DigitalAgency_td' ),
					'menu_title' => __( 'Theme Options', 'DigitalAgency_td' ),
	...
	public function blocks_category( $categories ) {
		$custom_block = array(
			'slug'  => 'theme-blocks',
			'title' => __( 'Theme Blocks', 'DigitalAgency_td' ),
			'icon'  => 'theme-blocks',
		);
	...
	public function wysiwyg_render_field_settings( $field ) {
		acf_render_field_setting(
			$field,
			array(
				'label'        => __( 'Height of Editor', 'DigitalAgency_td' ),
				'instructions' => __( 'Height of Editor after Init', 'DigitalAgency_td' ),
				'name'         => 'wysiwyg_height',
				'type'         => 'number',
			)
		);
	...
	public function include_acf_fields() {
		...
		acf_register_field_type( '\DigitalAgency\Acf\Acf_Fields\Acf_Field_Block_Label' );
		acf_register_field_type( '\DigitalAgency\Acf\Acf_Fields\Acf_Field_Headings' );
		acf_register_field_type( '\DigitalAgency\Acf\Acf_Fields\Acf_Field_Spacer' );
		acf_register_field_type( '\DigitalAgency\Acf\Acf_Fields\Acf_Field_Spacers' );
		acf_register_field_type( '\DigitalAgency\Acf\Acf_Fields\Acf_Field_Block_Title' );
		// acf_register_field_type( '\DigitalAgency\Acf\Acf_Fields\Acf_Field_Relational_Taxonomy' );
		// acf_register_field_type( '\DigitalAgency\Acf\Acf_Fields\Acf_Field_Advance_Form' );
		acf_register_field_type( '\DigitalAgency\Acf\Acf_Fields\Acf_Field_Advance_Video' );
		acf_register_field_type( '\DigitalAgency\Acf\Acf_Fields\Acf_Field_Date_Range_Picker' );
		acf_register_field_type( '\DigitalAgency\Acf\Acf_Fields\Acf_Media_Box' );
	}
