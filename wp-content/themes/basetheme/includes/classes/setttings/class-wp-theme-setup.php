...
class WP_Theme_Setup {
	...
	public function setup_function() {
		...
		load_theme_textdomain( 'DigitalAgency_td' );
		...
		register_nav_menus(
			array(
				'header-nav'       => __( 'Header Nav', 'DigitalAgency_td' ),
				'footer-nav-one'   => __( 'Footer Nav One', 'DigitalAgency_td' ),
				'footer-nav-two'   => __( 'Footer Nav Two', 'DigitalAgency_td' ),
				'footer-nav-three' => __( 'Footer Nav Three', 'DigitalAgency_td' ),
				'legal-nav'        => __( 'Legal Nav', 'DigitalAgency_td' ),
			)
		);
